...
--     external_id / estimate.calendar_event_id — zero hits).
...
alter table estimate drop column if exists calendar_event_id;
...
-- data_spine, harden_function_search_path, permit.
