...
- **O5 — Ask Mike: what does Sage (colorId 2) mean?** It spans all four cities
  and holds most REPEAT-tagged and "not home" events (76 in the sample) — a
  status-like category the data can't decode. ARBOR never writes '2' until
  Mike answers.
